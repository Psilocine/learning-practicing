...
/**
 * 目标：
 * 1. 实现 bluebird 库的 promiseify，promiseify 有什么作用呢？它的作用就是将异步回调函数 api 转换为 promise 形式，
 * 比如下面这个，对 fs.readFile 执行 promiseify后，就可以直接用 promise 的方式去调用读取文件的方法了，是不是很强大。
